          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
            ...
            >
              ...
              <div className="flex gap-3">
                <motion.a
                  href="http://twitter.com/draw2cost"
                  target="_blank"
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="bg-gray-700 hover:bg-blue-500 p-3 rounded-full transition-all duration-300"
                  title="Twitter"
                >
                ...
                <motion.a
                  href="http://linkedin.com/company/107666287"
                  target="_blank"
                  rel="noopener noreferrer"
                  whileHover={{ 
                    scale: 1.1, 
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="bg-gray-700 hover:bg-blue-600 p-3 rounded-full transition-all duration-300"
                  title="LinkedIn"
                >
                  <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
